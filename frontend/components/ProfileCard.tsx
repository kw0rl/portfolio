      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              {/* Dark overlay for better text readability against full photo */}
              <div
                className="absolute inset-0 z-[-1]"
                style={{
                  background: 'linear-gradient(to bottom, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 70%, rgba(0,0,0,0.4) 100%)',
                  borderRadius: cardRadius,
                }}
              />
              <img
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-[40px] overflow-hidden border border-white/10 flex-shrink-0"
            ...
            >
              <div className="w-full absolute flex flex-col items-center" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                ...
                <p
                  className="font-semibold whitespace-nowrap mx-auto mt-2"
                  style={{
                    fontSize: '16px',
                    display: 'block',
                    gridArea: 'auto',
